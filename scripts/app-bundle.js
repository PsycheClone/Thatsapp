...
define('chat',['exports', 'aurelia-authentication', 'aurelia-framework', 'aurelia-plugins-jwt-decode'], function (exports, _aureliaAuthentication, _aureliaFramework, _aureliaPluginsJwtDecode) {
  'use strict';
  ...
  var ChatComponent = exports.ChatComponent = (_dec = (0, _aureliaFramework.inject)(_aureliaAuthentication.AuthService), _dec(_class = function () {
...
define('login',['exports', 'aurelia-authentication', 'aurelia-router', 'aurelia-framework', 'aurelia-plugins-jwt-decode'], function (exports, _aureliaAuthentication, _aureliaRouter, _aureliaFramework, _aureliaPluginsJwtDecode) {
  'use strict';
  ...
  var Login = exports.Login = (_dec = (0, _aureliaFramework.inject)(_aureliaAuthentication.AuthService, _aureliaRouter.Router), _dec2 = (0, _aureliaFramework.computedFrom)('authService.authenticated'), _dec(_class = (_class2 = function () {
    ...
    Login.prototype.login = function login(username, password) {
      var self = this;
    ...
    Login.prototype.authenticate = function authenticate(name) {
      ...
      return this.authService.authenticate(name).then(function (response) {
        _this.provider[name] = true;
      });
    };
...
define('main',['exports', './environment'], function (exports, _environment) {
  ...
  function configure(aurelia) {
    aurelia.use.standardConfiguration().feature('resources').plugin('aurelia-api', function (configure) {
      configure.registerEndpoint('auth', 'http://localhost:3000').registerEndpoint('login', '/login').registerEndpoint('register', '/register').registerEndpoint('chat', '/chat');
...
define('register',["exports", "aurelia-http-client"], function (exports, _aureliaHttpClient) {
  "use strict";
...
define('user',['exports', 'aurelia-framework', 'aurelia-authentication', 'aurelia-router'], function (exports, _aureliaFramework, _aureliaAuthentication, _aureliaRouter) {
  ...
  var UserCustomElement = exports.UserCustomElement = (_dec = (0, _aureliaFramework.inject)(_aureliaRouter.Router, _aureliaAuthentication.AuthService), _dec2 = (0, _aureliaFramework.bindable)({ defaultBindingMode: _aureliaFramework.bindingMode.twoWay }), _dec(_class = (_class2 = function UserCustomElement(router, authService) {
...
define('text!login.html', ['module'], function(module) { module.exports = "<template>\n  <require from=\"bootstrap/css/bootstrap.css\"></require>\n\n  <div class=\"container-fluid\">\n    <div class=\"row align-items-center\" style=\"height: 100vh\">\n      <div class=\"col\"></div>\n      <div class=\"col-3\">\n        <form submit.delegate=\"login()\">\n          <div class=\"form-group row\">\n            <label for=\"nickname\" class=\"col-2 col-form-label\">Nickname: </label>\n            <div class=\"col-10\">\n              <input name=\"nickname\" id=\"nickname\" type=\"text\" class=\"form-control text-left\"\n                     placeholder=\"type here\" value.bind=\"nickname\">\n            </div>\n          </div>\n          <div class=\"form-group row\">\n            <label for=\"password\" class=\"col-2 col-form-label\">Password: </label>\n            <div class=\"col-10\">\n              <input name=\"password\" id=\"password\" type=\"password\" class=\"form-control text-left\"\n                       placeholder=\"type here\" value.bind=\"password\">\n            </div>\n          </div>\n          <div class=\"form-group row\">\n            <div class=\"input-group-btn col-12\">\n              <button class=\"btn btn-success\" type=\"submit\">Send</button>\n            </div>\n          </div>\n        </form>\n        <div class=\"form-group row\">\n          <div class=\"input-group-btn col-12\">\n            <button click.delegate=\"register()\" class=\"btn btn-info\">Register</button>\n          </div>\n        </div>\n      </div>\n      <div class=\"col\"></div>\n    </div>\n  </div>\n</template>\n"; });
